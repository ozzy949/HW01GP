...
constexpr auto qt_meta_stringdata_CLASSDrawAreaENDCLASS = QtMocHelpers::stringData(
    "DrawArea",
    "shapeDrawn",
    "",
    "Shape*",
...
void DrawArea::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        (void)_t;
        switch (_id) {
        case 0: _t->shapeDrawn((*reinterpret_cast< std::add_pointer_t<Shape*>>(_a[1]))); break;
        default: ;
        }
    } else if (_c == QMetaObject::IndexOfMethod) {
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            using _t = void (DrawArea::*)(Shape * );
            if (_t _q_method = &DrawArea::shapeDrawn; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void DrawArea::shapeDrawn(Shape * _t1)
{
